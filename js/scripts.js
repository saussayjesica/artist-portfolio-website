$(document).ready(function(){
  ...
  var $soundcloudFilterLinks = $('.soundcloud-filters li'),
      $containerSoundcloud = $('.soundcloud-items');

  $soundcloudFilterLinks.find('a').click(function(){

    $soundcloudFilterLinks.removeClass('active');

    $containerSoundcloud.isotope({
      // options
      filter: $(this).attr('data-filter'),
      itemSelector: '.isotope-item',
      animationEngine : "best-available",
